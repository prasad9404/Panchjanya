...
export default function UserOnboarding() {
  ...
  const [formData, setFormData] = useState({
    ...
    vidyaGuruvaryaPlace: "",
    vidyaGuruvaryaYear: "",
    vidyaStudiedMode: "" as "Offline" | "Online" | "",
    dikshaGuruvaryaName: "",
  ...
  const nextStep = () => setStep((p) => Math.min(p + 1, 7) as OnboardingStep);
          ...
          <div className="mb-10">
            <div className="flex items-center justify-between mb-3 px-1">
              <span className="text-[10px] font-black text-blue-900/40 uppercase tracking-[0.2em]">
                Sacred Initiation — Step {step} of 6
              </span>
              ...
              <div className="text-center">
                 ...
                 <div className="p-6 bg-blue-50/50 rounded-3xl border border-blue-100 text-left">
                    <p className="text-sm text-blue-900/70 leading-relaxed font-medium">
                      This app is specially made for followers of the Mahanubhav Panth. To confirm your participation, please provide the following spiritual details.
                    </p>
                 </div>
              </div>

              <div className="space-y-4">
                 <label className="text-[10px] font-black text-blue-900/40 uppercase tracking-widest block ml-4 text-center">Select Your Spiritual Status</label>
                   ...
                   <button
                     ...
                     className={cn(
                       ...
                       formData.status === status 
                         ? "border-amber-400 bg-white ring-8 ring-accent/5 shadow-md" 
                   ...
                   >
                     <div className="flex items-center gap-4">
                        <div className={cn(
                          ...
                          formData.status === status ? "bg-accent text-white" : "bg-slate-50 text-slate-300"
                        )}>
                           <div className="w-4 h-4 rounded-full border-2 border-current" />
                        </div>
                        <span className="font-serif font-black text-xl text-blue-950 uppercase italic">{status}</span>
                     </div>
                     {formData.status === status && <CheckCircle2 className="w-6 h-6 text-accent" />}
                   </button>
                 ))}
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-6 bg-white border border-slate-100 rounded-[2.5rem] space-y-6 shadow-sm">
                    ...
                    <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-2xl">
                       <span className="font-bold text-sm text-blue-950">Taken Name Mantra?</span>
                       <button 
                    ...
                    <div className="grid grid-cols-2 gap-4">
                       ...
                       <AuthInputField topLabel="Taluka" label="Taluka" value={formData.guruvaryaTaluka} onChange={e => setFormData({...formData, guruvaryaTaluka: e.target.value})} />
                    </div>
                    
                    <div className="grid grid-cols-2 gap-4">
                       <AuthInputField topLabel="District" label="District" value={formData.guruvaryaDistrict} onChange={e => setFormData({...formData, guruvaryaDistrict: e.target.value})} />
                       <AuthInputField topLabel="Year" label="2024" type="number" value={formData.guruvaryaYear} onChange={e => setFormData({...formData, guruvaryaYear: e.target.value})} />
                    </div>
                  </div>
                  ...
                  {formData.status === "Vasnik" && (
                    <div className="p-6 bg-white border border-slate-100 rounded-[2.5rem] space-y-6 shadow-sm">
                      ...
                      <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase text-blue-900/40 ml-4 tracking-widest">Knowledge of Brahmanavidya</label>
                        <textarea 
                      ...
                      <div className="space-y-3">
                         <label className="text-[10px] font-black text-blue-900/40 uppercase tracking-widest ml-4">Studied Mode</label>
                         <div className="flex gap-4">
